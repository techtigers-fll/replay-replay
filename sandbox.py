...
def run(robot: Robot):
    ...
    # robot.move_linear(-800, 1, False)
    # robot.drive(drive_pid, 200, -32, 1700)

    robot.move_linear(-400, 1.3)
    robot.drive(drive_pid, 150, 0, 1000)
    robot.move_linear(400, 1.05, False)
    wait(200)
    robot.drive(drive_pid, -150, 0, 1500)
